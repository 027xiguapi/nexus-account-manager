...
interface ClaudeAccountDetailsDialogProps {
  account: ClaudeAccount
  open: boolean
  onClose: () => void
}

export function ClaudeAccountDetailsDialog({ account, open, onClose }: ClaudeAccountDetailsDialogProps) {
    ...
    <AccountDetailsDialog
      ...
      badges={
        <>
          ...
          <Badge variant="outline" className="bg-background/50">Claude</Badge>
        </>
      }
      sections={sections}
      maxWidth="lg"
